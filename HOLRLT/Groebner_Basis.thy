...
lemmas bool_simps = simp_thms(1-34) \<comment> \<open>FIXME move to HOLRLT.HOL\<close>

lemma nnf_simps: \<comment> \<open>FIXME shadows fact binding in HOLRLT.HOL\<close>
