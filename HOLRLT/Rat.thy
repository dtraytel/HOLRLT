...
wide_typedef rat rel: "(=) :: rat \<Rightarrow> rat \<Rightarrow> bool" rep: Rep_rat
  by (auto simp only: restr_eq rlt_eq rrel_eq type_definition_bij_upto[OF type_definition_rat])
