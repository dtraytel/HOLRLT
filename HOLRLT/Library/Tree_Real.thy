...
text \<open>
  This theory is separate from \<^theory>\<open>HOLRLT-Library.Tree\<close> because the former is discrete and
  builds on \<^theory>\<open>MainRLT\<close> whereas this theory builds on \<^theory>\<open>Complex_MainRLT\<close>.
\<close>
