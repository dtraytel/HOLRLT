...
wide_typedef real rel: "(=) :: real \<Rightarrow> real \<Rightarrow> bool" rep: Rep_real
  by (auto simp only: restr_eq rlt_eq rrel_eq type_definition_bij_upto[OF type_definition_real])
